...
- **Smart tiering** - file context automatically adjusts based on total
  size
- **Configuration files** - CASSIDY.md files provide project-specific
  instructions
...
5.  **Explain design decisions** - help me understand the “why” behind
    choices
...
Detailed reference documentation is available in `.cassidy/rules/`:
