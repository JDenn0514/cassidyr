...
│   ├── agentic-helpers.R               ✓ Complete (List tools, presets)
│   ├── agentic-tools.R                 ✓ Complete (Tool registry & execution)
│   ├── agentic-workflow.R              ✓ Complete (Direct tool decision parsing)
│   │
...
│   │
│   ├── cli-install.R                   ✓ Complete (CLI tool installation)
│   │
...
│       ├── test-agentic-live.R
│       ├── test-agentic-direct-parsing.R
│       └── test-skills-context-window.R
│
├── inst/
│   └── cli/
│       └── cassidy.R                 ✓ Complete (CLI executable script)
│
...
- `cli-install.R` - Install/uninstall cassidy CLI tool to system PATH
